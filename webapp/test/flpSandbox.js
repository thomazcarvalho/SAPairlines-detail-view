					...
					"config": {
						"inbounds": {
							"CompanhiasAereas-display": {
								...
								"action": "display",
								"description": "App para vizualização e detalhes de Companhias Aéreas.",
								"title": "CompanhiasAereas",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=thomaz.CompanhiasAereas",
									"url": sap.ui.require.toUrl("thomaz/CompanhiasAereas")
								}
							}
						}
					}
